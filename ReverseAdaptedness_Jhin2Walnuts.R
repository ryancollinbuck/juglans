...
#################################################################################
###############################################################################
Jhin_2p5 <- vect("Jhin_2p5km_ALL_Clip.shp")
Jhin_2p5 <- project(Jhin_2p5, crs(ras_8110))
Jhinmask <- mask(crop(ras_8110, Jhin_2p5), Jhin_2p5)
currClim <- as.data.frame(Jhinmask,cells = TRUE)
currClim <- na.omit(currClim)
transClim<-predict(gf,currClim[,-(1)])

# SPATIO-TEMPORAL OFFSETS -------------------------------------------------
currClim1<- as.data.frame(Jhinmask,xy=TRUE,cells = TRUE)
...
writeRaster(new_DIraster, "newloop_JH_AVGdonorOffset_toWalnuts_C852070.tif", filetype="GTiff", overwrite=TRUE)
...
crs(new_DIraster) <- crs(original_raster)
writeRaster(new_DIraster, "newloop_JH_AVGdonorOffset_toWalnuts_C852040.tif", filetype="GTiff", overwrite=TRUE)
...
crs(new_DIraster) <- crs(original_raster)
writeRaster(new_DIraster, "newloop_JH_AVGdonorOffset_toWalnuts_C452070.tif", filetype="GTiff", overwrite=TRUE)
...
crs(new_DIraster) <- crs(original_raster)
writeRaster(new_DIraster, "newloop_JH_AVGdonorOffset_toWalnuts_C452040.tif", filetype="GTiff", overwrite=TRUE)
...
crs(new_DIraster) <- crs(original_raster)
writeRaster(new_DIraster, "newloop_JH_AVGdonorOffset_toWalnuts_H852070.tif", filetype="GTiff", overwrite=TRUE)
...
crs(new_DIraster) <- crs(original_raster)
writeRaster(new_DIraster, "newloop_JH_AVGdonorOffset_toWalnuts_H852040.tif", filetype="GTiff", overwrite=TRUE)
...
crs(new_DIraster) <- crs(original_raster)
writeRaster(new_DIraster, "newloop_JH_AVGdonorOffset_toWalnuts_H452070.tif", filetype="GTiff", overwrite=TRUE)
...
crs(new_DIraster) <- crs(original_raster)
writeRaster(new_DIraster, "newloop_JH_AVGdonorOffset_toWalnuts_H452040.tif", filetype="GTiff", overwrite=TRUE)
