...
writeRaster(new_DIraster, "newloop_JH_AVGrecipientOffset_toALLcrops_C852070.tif", filetype="GTiff", overwrite=TRUE)
...
crs(new_DIraster) <- crs(original_raster)
writeRaster(new_DIraster, "newloop_JH_AVGrecipientOffset_toALLcrops_C852040.tif", filetype="GTiff", overwrite=TRUE)
...
crs(new_DIraster) <- crs(original_raster)
writeRaster(new_DIraster, "newloop_JH_AVGrecipientOffset_toALLcrops_C452070.tif", filetype="GTiff", overwrite=TRUE)
...
crs(new_DIraster) <- crs(original_raster)
writeRaster(new_DIraster, "newloop_JH_AVGrecipientOffset_toALLcrops_H852070.tif", filetype="GTiff", overwrite=TRUE)
...
crs(new_DIraster) <- crs(original_raster)
writeRaster(new_DIraster, "newloop_JH_AVGrecipientOffset_toALLcrops_H852040.tif", filetype="GTiff", overwrite=TRUE)
...
crs(new_DIraster) <- crs(original_raster)
writeRaster(new_DIraster, "newloop_JH_AVGrecipientOffset_toALLcrops_H452070.tif", filetype="GTiff", overwrite=TRUE)
